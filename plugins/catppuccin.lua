...
-- Partially copied from https://github.com/catppuccin/wezterm/blob/main/plugin/init.lua
local colors = {
	latte = {
		rosewater = "#dc8a78",
		flamingo = "#dd7878",
